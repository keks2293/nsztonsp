...
0. **Perf: `--update` BKTR merge — selective NCZ decompression** — `fs/update.js`. Previously fully decompressed both Program NCAs into memory. Now: reads only needed sections via streaming NCZ decompression:
